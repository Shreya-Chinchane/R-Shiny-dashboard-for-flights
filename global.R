library(shiny)                   # this packages is used for Shiny App
library(shinydashboard)          # this packages is used for Shiny Dashboard

library(dplyr)                   # this packages is used for data preparation (edit, remove, mutate, etc)
